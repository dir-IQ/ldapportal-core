...
- **Date:** 2026-06-05
- **Status:** In progress (Phases 0–2 shipped: API hardening, Ansible/REST docs,
  and the declarative startup bootstrap file — see `docs/iac/` and
  `BootstrapConfigReconciler`; Phase 3 scoped tokens / Phase 4 Terraform not
  started, 2026-06-05).
